...
public class CurrentOrdersFragment extends Fragment {
    ...
    public static CurrentOrdersFragment fragment;
    ...
    @BindView(R.id.fragment_current_orders_cl_container)
    ConstraintLayout container;
    @BindView(R.id.fragment_current_orders_ll_startDateContainer)
    LinearLayout startDateContainer;
    @BindView(R.id.fragment_current_orders_ll_endDateContainer)
    LinearLayout endDateContainer;
    @BindView(R.id.fragment_current_orders_tv_startDate)
    TextView startDate;
    @BindView(R.id.fragment_current_orders_tv_endDate)
    TextView endDate;
    @BindView(R.id.fragment_current_orders_rv_orders)
    RecyclerView orders;
    @BindView(R.id.loading)
    ProgressBar loading;

    public static CurrentOrdersFragment newInstance(FragmentActivity activity) {
        fragment = new CurrentOrdersFragment();
        CurrentOrdersFragment.activity = activity;
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        childView = inflater.inflate(R.layout.fragment_current_orders, container, false);
    ...
    private void initOrders() {
        ...
        ordersAdapter = new OrdersAdapter(activity, ordersList, false, new OrdersAdapter.OnItemClickListener() {
            @Override
    ...
    @OnClick(R.id.fragment_current_orders_ll_startDateContainer)
    ...
    @OnClick(R.id.fragment_current_orders_ll_endDateContainer)
    ...
    @OnClick(R.id.fragment_current_orders_iv_done)
    ...
    private void ordersApi() {
        ...
        RetrofitConfig.getServices().GET_ORDERS_CALL(sessionManager.getUserLanguage(), Constants.AUTHORIZATION_VALUE, sessionManager.getUserId(),
